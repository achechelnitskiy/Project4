...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    //changed querySelector to getElementByClassName
    var allPizzas = document.getElementsByClassName('randomPizzaContainer');
    var theLength = allPizzas.length;

    //Since all pizza's using same properties, took outside the loop and using index of 1
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  /* reduced number of pizzas to 30 and setting style.left */
  for (var i = 0; i < 30; i++) {
